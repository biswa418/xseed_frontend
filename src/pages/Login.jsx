    ...
    return (
        <form className="form_container main mt-4">
            ...
            <div className="input_container">
                ...
                <input placeholder="name@email.com" title="Input title" name="input-name" type="text" className="input_field rounded-full" id="email_field" />
            </div>
            ...
            <div className="input_container">
                ...
                <input placeholder="Password" title="Input title" name="input-name" type="password" className="input_field rounded-full" id="password_field" />
            </div>


            <button title="Sign In" type="submit" className="bg-[#115DFC] sign_in_btn text-white rounded-full">
                <span>Sign In</span>
            </button>
