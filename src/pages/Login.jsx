...
const Login = () => {
    ...
    return (
        <div className='main'>
            <form className="form_container min-w-full md:min-w-max md:w-1/2 mb-6">
                ...
                <div className="input_container">
                    ...
                    <input placeholder="name@email.com" required value={details.name} onChange={(e) => setDetails({ ...details, 'name': e.target.value })} title="Input title" name="name" type='email' className="input_field rounded-full" id="email_field" />
                </div>
                ...
                <div className="input_container">
                    ...
                    <input placeholder="Password" value={details.password} onChange={(e) => setDetails({ ...details, 'password': e.target.value })} title="Input title" name="password" type="password" className="input_field rounded-full" id="password_field" />
                </div>


                <button title="Sign In" disabled={submit} onClick={(e) => handleSubmit(e)} type="submit" className="bg-[#115DFC] sign_in_btn text-white rounded-full">
                    {
                        submit && <span>Signing in ...</span>
                    }
                    {
                        !submit &&
                        <span>Sign In</span>
                ...
                <button title="Sign Up" className="text-gray-500 mb-4">
