    ...
    return (
        <form className="form_container main mt-4 min-w-full md:min-w-min md:w-1/2 mb-6">
            ...
            <div className="input_container">
                ...
                <input placeholder="name@email.com" value={details.name} onChange={(e) => setDetails({ ...details, 'name': e.target.value })} title="Input title" name="name" type="text" className="input_field rounded-full" id="email_field" />
            </div>
